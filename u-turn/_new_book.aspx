<%@ Page Title="" Language="VB" MasterPageFile="~/back.master" AutoEventWireup="false"
    CodeFile="_new_book.aspx.vb" Inherits="_new_book" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    ...
    <div id="content" class="div_auto">
        <div id="content-page-container">
            ...
            <asp:Label ID="lblDone" runat="server" Visible="false" Text="Book Added." CssClass="hideme done back_green padded rounded_5 color_white font_courier fonts_1_2"></asp:Label>
            <a href="_books.aspx" class="save-btn back_endeavour rounded_5 padded color_white font_courier fonts_1_2">Back to Books</a>&nbsp
            <a href="_books_arabic.aspx" class="save-btn back_endeavour rounded_5 padded color_white font_courier fonts_1_2">Back to Arabic Books</a>&nbsp;
            <asp:LinkButton ID="btnAdd" runat="server" Text="Add Book"   CssClass="save-btn back_endeavour rounded_5 padded color_white font_courier fonts_1_2"></asp:LinkButton>
            <br /><br /><br />
