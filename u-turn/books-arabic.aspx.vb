...
Partial Class books_arabic
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ds_Books.SelectCommand = "select [id], title, author, publisher, price, image, category, dir, isrtl from books where isrtl = 1 ORDER BY position ASC"
            ds_Books.DataBind()
    ...
    Protected Sub RadSearchBox1_Search(sender As Object, e As Telerik.Web.UI.SearchBoxEventArgs) Handles RadSearchBox1.Search
        ds_Books.SelectCommand = "select [id], title, author, publisher, price, image, dir, isrtl, category from books where isrtl = 1 and id=" & e.Value
