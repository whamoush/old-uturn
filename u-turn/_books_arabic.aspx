<%@ Page Title="" Language="VB" MasterPageFile="~/back.master" AutoEventWireup="false"
    CodeFile="_books_arabic.aspx.vb" Inherits="_books_arabic" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <uc2:current ID="current1" runat="server" _menuItem="lbNine" _menuItemMobile="lbMobileNine" />
    ...
    <div id="content" class="div_auto">
        <div id="content-page-container">
                        ...
                        <ItemTemplate>
                            ...
                            <li class="rounded_5" style='background: <%#Eval("color")%>; direction: <%#Eval("dir")%>;'>
                                <asp:LinkButton ID="lbCategorize" CommandName="categorize" runat="server" Text='<%#Eval("category")%>'></asp:LinkButton>
                                    <strong>-<asp:Literal ID="ltlCount" runat="server"></asp:Literal>-</strong> </li>
                        </ItemTemplate>
                    </asp:Repeater>
            ...
            <asp:SqlDataSource ID="ds_Books" runat="server" ConnectionString="<%$ ConnectionStrings:UturnCS %>" SelectCommand="select * from books where dir = 'rtl' order by id desc"></asp:SqlDataSource>
